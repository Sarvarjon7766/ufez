...
const Banner = () => {
	...
	const translations = {
		uz: {
			title: '"Urgut erkin iqtisodiy zona Direktsiyasi"',
			organization: "Davlat unitar korxonasi",
			watchVideo: "Video rolik ko'rish",
		},
		ru: {
			title: '"Дирекция Ургутской свободной экономической зоны"',
			organization: "Государственное унитарное предприятие",
			watchVideo: "Смотреть видео",
		},
		en: {
			title: '"Urgut Free Economic Zone Directorate"',
			organization: "State Unitary Enterprise",
			...
			<section className="relative w-full h-screen flex flex-col overflow-hidden">
				...
				<div className="relative z-10 flex-1 flex items-center justify-center">
					<div className="w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
						...
						<p className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-semibold inline-block px-4 sm:px-6 py-2 sm:py-3 rounded-xl border-none border-white/30 mb-4 sm:mb-6">
							{t.organization}
						</p>

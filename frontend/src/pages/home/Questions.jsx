										...
										<button
											...
											className={`
												...
												${activeQuestion === index
													...
													: 'bg-gray-50 hover:bg-white text-gray-700 hover:shadow-md border border-gray-200 hover:border-blue-200'
												}
											`}
										>
											<div className="flex items-center gap-4">
												...
												<div className="flex-1 min-w-0">
													<div className={`text-sm font-semibold leading-tight ${activeQuestion === index ? 'text-white' : 'text-gray-800'}`}>
														{asked.question}
													</div>
												</div>
												<ChevronDown
													...
													className={`
														...
														${activeQuestion === index ? 'text-white rotate-180' : 'text-gray-400 group-hover:text-blue-500'}
													`}
												/>
											</div>
										</button>
										...
										{askeds[activeQuestion]?.ask.split('. ').map((sentence, index, array) =>
											sentence && (
												<p key={index} className="flex items-start gap-3">
													<span className="flex-shrink-0 w-2 h-2 bg-blue-400 rounded-full mt-3"></span>

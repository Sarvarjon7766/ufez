			...
			<div className="w-full max-w-md relative z-10">
				...
				<div className="bg-white/10 backdrop-blur-lg rounded-3xl shadow-2xl border border-white/20 overflow-hidden">
					...
					<div className="p-8 text-center">
						<h1 className="text-3xl font-bold text-white mb-2">UFEZ</h1>
					...
					<form onSubmit={handleLogin} className="p-8">
						...
						<button
							type="submit"
							disabled={isLoading}
							className="w-full bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 disabled:from-blue-400 disabled:to-purple-500 text-white py-4 px-6 rounded-xl font-semibold shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-300 flex items-center justify-center"
						>
							{isLoading ? (
								<>

...
const Completed = () => {
	...
	const translations = {
		uz: {
			...
			noData: "Yakunlangan loyihalar hozircha mavjud emas.",
			companyName: "Kompaniya nomi",
			projectName: "Loyiha nomi",
			contact: "Aloqa",
			completedProjects: "Muvaffaqiyatli yakunlangan loyihalar"
		},
		ru: {
			title: "Завершенные Проекты",
			loading: "Проекты загружаются...",
			noData: "Завершенные проекты пока недоступны.",
			companyName: "Название компании",
			projectName: "Название проекта",
			contact: "Контакт",
			completedProjects: "Успешно завершенные проекты"
		},
		en: {
			title: "Completed Projects",
			loading: "Loading projects...",
			noData: "No completed projects available yet.",
			companyName: "Company Name",
			projectName: "Project Name",
			contact: "Contact",
			completedProjects: "Successfully Completed Projects"
		}
	}
	...
	const fetchProjects = async (lang = language) => {
		try {
			setLoading(true)
			const res = await axios.get(`${BASE_URL}/api/project/getAll/${lang}/completed`)
	...
	const getExampleData = () => {
		return [
			{
				id: 1,
				companyName: "Textile Group LLC",
				projectName: "Zamonaviy to'qimachilik fabrikasi",
				contact: "+998 90 123 45 67"
			},
			{
				id: 2,
				companyName: "Agro Invest MCHJ",
				projectName: "Qishloq xo'jaligi mahsulotlarini qayta ishlash zavodi",
				contact: "+998 91 234 56 78"
			},
			{
				id: 3,
				companyName: "Tech Solutions Inc",
				projectName: "Elektronika ishlab chiqarish korxonasi",
				contact: "+998 93 345 67 89"
			},
			{
				id: 4,
				companyName: "Green Energy LLC",
				projectName: "Quyosh energiyasi stansiyasi",
				contact: "+998 94 456 78 90"
			},
			{
				id: 5,
				companyName: "Food Processing Co",
				projectName: "Oziq-ovqat mahsulotlarini ishlab chiqarish",
				contact: "+998 95 567 89 01"
			}
		]
	}

...
const Offer = () => {
	...
	const translations = {
		uz: {
			...
			noData: "Taklif qilingan loyihalar hozircha mavjud emas.",
			companyName: "Kompaniya nomi",
			projectName: "Loyiha nomi",
			contact: "Aloqa",
			offeredProjects: "Investorlar tomonidan taklif qilingan loyihalar"
		},
		ru: {
			title: "Предложенные Проекты",
			loading: "Проекты загружаются...",
			noData: "Предложенные проекты пока недоступны.",
			companyName: "Название компании",
			projectName: "Название проекта",
			contact: "Контакт",
			offeredProjects: "Проекты, предложенные инвесторами"
		},
		en: {
			title: "Offered Projects",
			loading: "Loading projects...",
			noData: "No offered projects available yet.",
			companyName: "Company Name",
			projectName: "Project Name",
			contact: "Contact",
			offeredProjects: "Projects Offered by Investors"
		}
	}
	...
	const fetchProjects = async (lang = language) => {
		try {
			setLoading(true)
			const res = await axios.get(`${BASE_URL}/api/project/getAll/${lang}/offer`)
	...
	const getExampleData = () => {
		return [
			{
				id: 1,
				companyName: "Innovation Tech Group",
				projectName: "Sun'iy intellekt asosidagi qishloq xo'jaligi tizimi",
				contact: "+998 90 777 88 99"
			},
			{
				id: 2,
				companyName: "Eco Tourism Ltd",
				projectName: "Ekologik turizm majmuasi",
				contact: "+998 91 888 99 00"
			},
			{
				id: 3,
				companyName: "Digital Education Corp",
				projectName: "Raqamli ta'lim platformasi",
				contact: "+998 93 999 00 11"
			},
			{
				id: 4,
				companyName: "Smart Logistics Co",
				projectName: "Aqlli logistika markazi",
				contact: "+998 94 111 22 33"
			},
			{
				id: 5,
				companyName: "Health Tech Solutions",
				projectName: "Telemeditsina xizmatlari platformasi",
				contact: "+998 95 222 33 44"
			}
		]
	}
